<template>
  <section class="team-section pt-5 pb-5">
    <div class="container">
      <leader style="display: block; margin-bottom: 50px">
...
export default {
  ...
  mounted() {
    ...
    link3.href = "https://daneden.github.io/animate.css/animate.min.css";
...
.team-member .image-box .hover-img {
  position: absolute;
  top: 0;
  left: 0;
  opacity: 0;
...
.team-member .image-box:hover .hover-img {
  opacity: 1;
}

.team-member .image-box:hover .main-img {
  opacity: 0;
}
