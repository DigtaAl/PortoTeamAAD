<template>
  <main>
    ...
    <section v-if="year === '2023'"></section>
    <section v-if="year === '2022'"></section>
    <section v-if="year === '2021'"></section>
    <section v-if="year === '2020'"></section>
    <section v-if="year === '2019'"></section>
  </main>
</template>
